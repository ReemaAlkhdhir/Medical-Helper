...
class StockPharm extends StatefulWidget {
  @override
  _StockPharmState createState() => _StockPharmState();
}

class _StockPharmState extends State<StockPharm> {
  final String jsonSample =
      '[{"Code":"12345","Company_Name":"Pfizer","Concentration":"200mg","Form":"Drugs","medicine_name":"AMLOR","Quantity_Num":"66"}]';
